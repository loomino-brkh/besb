...
class APIKey(models.Model):
    ...
    allowed_endpoint = models.CharField(max_length=255, help_text="Endpoint this API key is allowed to access", null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        expires_in_days = kwargs.pop('expires_in_days', None)
        if expires_in_days:
